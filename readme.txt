...
* Easier setup with custom domain instructions.
...
* Multi payout for the custom mode.
* Customized fees tolerance for the multi-provider mode.
...
* Updated providers list and bug fix.
...
* New Providers
* Multi hosted checkout page customization.
