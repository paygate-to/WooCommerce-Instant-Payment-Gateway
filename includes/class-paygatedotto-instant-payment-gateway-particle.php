...
class PayGateDotTo_Instant_Payment_Gateway_Particle extends WC_Payment_Gateway {
    ...
    protected $particlenetwork_custom_domain;
    ...
    public function __construct() {
        ...
        $this->particlenetwork_custom_domain = rtrim(str_replace(['https://','http://'], '', sanitize_text_field($this->get_option('particlenetwork_custom_domain'))), '/');
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'particlenetwork_custom_domain' => array(
...
if (paygatedottogateway_is_checkout_block()) {
	...
	$woocommerce->cart->empty_cart();
        ...
        return array(
            'result'   => 'success',
            'redirect' => 'https://' . $this->particlenetwork_custom_domain . '/process-payment.php?address=' . $paygatedottogateway_particlenetwork_gen_addressIn . '&amount=' . (float)$paygatedottogateway_particlenetwork_final_total . '&provider=particle&email=' . $paygatedottogateway_particlenetwork_email . '&currency=' . $paygatedottogateway_particlenetwork_currency,
        );
    }
...
function paygatedottogateway_add_instant_payment_gateway_particle($gateways) {
    $gateways[] = 'PayGateDotTo_Instant_Payment_Gateway_Particle';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottogateway_add_instant_payment_gateway_particle');
}
