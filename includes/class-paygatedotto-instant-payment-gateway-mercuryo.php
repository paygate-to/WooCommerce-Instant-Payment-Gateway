...
class PayGateDotTo_Instant_Payment_Gateway_Mercuryo extends WC_Payment_Gateway {
    ...
    protected $mercuryoio_custom_domain;
    ...
    public function __construct() {
        ...
        $this->mercuryoio_custom_domain = rtrim(str_replace(['https://','http://'], '', sanitize_text_field($this->get_option('mercuryoio_custom_domain'))), '/');
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'mercuryoio_custom_domain' => array(
...
if (paygatedottogateway_is_checkout_block()) {
	...
	$woocommerce->cart->empty_cart();
        ...
        return array(
            'result'   => 'success',
            'redirect' => 'https://' . $this->mercuryoio_custom_domain . '/process-payment.php?address=' . $paygatedottogateway_mercuryoio_gen_addressIn . '&amount=' . (float)$paygatedottogateway_mercuryoio_final_total . '&provider=mercuryo&email=' . $paygatedottogateway_mercuryoio_email . '&currency=' . $paygatedottogateway_mercuryoio_currency,
        );
    }
