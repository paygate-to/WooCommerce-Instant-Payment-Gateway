...
if (paygatedottogateway_is_checkout_block()) {
	...
	$woocommerce->cart->empty_cart();
        ...
        return array(
            'result'   => 'success',
            'redirect' => 'https://' . $this->transakcom_custom_domain . '/process-payment.php?address=' . $paygatedottogateway_transakcom_gen_addressIn . '&amount=' . (float)$paygatedottogateway_transakcom_final_total . '&provider=transak&email=' . $paygatedottogateway_transakcom_email . '&currency=' . $paygatedottogateway_transakcom_currency,
        );
    }
